...
四、上机考试结束前15分钟应试人员不能交卷出场。
        ...
        self.pl.setText(self.problem[self.now_problem_id]['content'])
...
东北大学的英文缩写是?-***-A.NEU B.BEU C.CEU D.DEU-***-A
    ...
    def get_grade(self):
        try:
            ...
            self.lable2.setText(req.content)
        except Exception as e:
            print(e)
